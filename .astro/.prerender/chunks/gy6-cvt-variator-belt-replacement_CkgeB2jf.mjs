...
const frontmatter = {
  ...
  "difficulty": "Beginner",
  "timeEstimate": "~30 min",
  "tags": ["gy6", "cvt", "variator", "belt", "transmission"],
...
function getHeadings() {
  return [{
    ...
    "depth": 4,
    "slug": "gy6-variator-roller-replacement",
    "text": "GY6 Variator Roller Replacement"
  }, {
    "depth": 4,
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h2, {
      ...
      children: ["\n", createVNode(_components.li, {
        children: "Socket set (metric): 8 mm, 10 mm, 17 mm, 22 mm (or as required for your specific nuts)"
      }), "\n", createVNode(_components.li, {
        children: [createVNode(_components.strong, {
          children: "Variator holding tool"
        }), " (universal GY6 type) — essential; do not attempt to use a screwdriver to jam the variator"]
      }), "\n", createVNode(_components.li, {
        children: "Impact wrench or breaker bar (the variator nut is torqued very tight)"
      }), "\n", createVNode(_components.li, {
        children: "Torque wrench"
      }), "\n", createVNode(_components.li, {
        children: "Soft mallet or rubber hammer"
      }), "\n", createVNode(_components.li, {
        children: "Cleaning rags"
      }), "\n", createVNode(_components.li, {
        children: "Replacement belt (confirm dimensions — see Specifications below)"
      }), "\n", createVNode(_components.li, {
        children: "Replacement rollers if required"
      }), "\n"]
    }), "\n", createVNode(_components.h2, {
      ...
      children: "🎬 Video Guide — Simplest Way to Replace a GY6 CV Belt"
      ...
      children: ["\n", createVNode(_components.li, {
        ...
        children: "Remove the cover. Inspect the inside for belt dust, cracked rubber fragments, or oil contamination (indicates a crankshaft seal leak)."
      }), "\n"]
    }), "\n", createVNode(_components.p, {
      children: "2"
    }), "\n", createVNode(_components.p, {
      children: "Remove the Drive Belt"
    }), "\n", createVNode(_components.ol, {
      children: ["\n", createVNode(_components.li, {
      ...
      children: "Remove the Variator (for roller replacement)"
    }), "\n", createVNode(_components.ol, {
      children: ["\n", createVNode(_components.li, {
        children: ["\n", createVNode(_components.p, {
        ...
        children: ["\n", createVNode(_components.p, {
          children: ["With an impact wrench or breaker bar, remove the variator nut (right-hand thread — turn counter-clockwise to loosen). This nut is typically torqued to ", createVNode(_components.strong, {
        ...
        children: ["\n", createVNode(_components.p, {
          children: "Remove the rollers. There are typically 6 rollers inside a guide cage. Inspect each one: flat spots, grooves worn into the roller surface, or irregular wear all indicate replacement is needed."
        }), "\n"]
      }), "\n", createVNode(_components.li, {
        children: ["\n", createVNode(_components.p, {
          children: createVNode(_components.strong, {
          ...
          children: ["\n", createVNode(_components.li, {
            children: ["GY6 50cc (139QMB): ", createVNode(_components.strong, {
              children: "16×13 mm"
            }), " @ 7.5–8.5 g (OEM stock weight varies; aftermarket range 5–11.5g)"]
          }), "\n", createVNode(_components.li, {
          ...
          children: createVNode(_components.em, {
            children: "Always use the correct diameter (16×13, 18×14, etc.) for your engine — mixing sizes causes CVT failure. Heavier rollers delay engagement (better top speed); lighter rollers engage earlier (better acceleration). Do not deviate more than 2 g from stock unless tuning for a specific purpose."
          })
        }), "\n"]
      }), "\n", createVNode(_components.li, {
        children: ["\n", createVNode(_components.p, {
          children: ["Clean the variator ramp surfaces and roller guides with a rag. ", createVNode(_components.strong, {
            children: "Do not use grease on the rollers"
          }), " — they must run dry. Grease attracts belt dust and causes premature wear."]
        }), "\n"]
      }), "\n", createVNode(_components.li, {
        children: ["\n", createVNode(_components.p, {
          children: ["Install new rollers in the guide cage, reinstall the outer variator face, and torque the nut to ", createVNode(_components.strong, {
            children: "49 Nm"
          }), "."]
        }), "\n"]
      }), "\n"]
      ...
      children: "Install the New Belt & Reassemble"
    }), "\n", createVNode(_components.ol, {
      children: ["\n", createVNode(_components.li, {
      ...
      id: "gy6-variator-roller-replacement",
      children: "GY6 Variator Roller Replacement"
    }), "\n", createVNode(_components.p, {
      children: "Focused guide on removing the variator, inspecting and replacing the centrifugal rollers, and checking belt condition on a GY6 scooter."
    }), "\n", createVNode(_components.p, {
...
const file = "/sessions/friendly-eager-maxwell/mnt/interactive scooter repair manuals - ISRM/src/content/repair-guides/gy6-cvt-variator-belt-replacement.mdx";
...
Content.moduleId = "/sessions/friendly-eager-maxwell/mnt/interactive scooter repair manuals - ISRM/src/content/repair-guides/gy6-cvt-variator-belt-replacement.mdx";
