...
const frontmatter = {
  ...
  "description": "Step-by-step checklist for diagnosing GY6 EFI faults: grounding, fuel pressure (42 PSI), air leaks, TPS reset, woodruff key, and fuel pump regulator.",
...
const file = "/sessions/friendly-eager-maxwell/mnt/interactive scooter repair manuals - ISRM/src/content/diagnostics/gy6-efi-system-troubleshooting-checklist.mdx";
...
Content.moduleId = "/sessions/friendly-eager-maxwell/mnt/interactive scooter repair manuals - ISRM/src/content/diagnostics/gy6-efi-system-troubleshooting-checklist.mdx";
