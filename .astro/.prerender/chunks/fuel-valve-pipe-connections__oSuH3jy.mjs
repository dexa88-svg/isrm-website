...
const frontmatter = {
  ...
  "description": "How to identify and correctly connect the two hoses on a vacuum-operated fuel valve (petcock): fuel hose to carburettor inlet, vacuum hose to intake manifold. GY6 & Piaggio.",
...
const file = "/sessions/sharp-gifted-meitner/mnt/interactive scooter repair manuals - ISRM/src/content/repair-guides/fuel-valve-pipe-connections.mdx";
...
Content.moduleId = "/sessions/sharp-gifted-meitner/mnt/interactive scooter repair manuals - ISRM/src/content/repair-guides/fuel-valve-pipe-connections.mdx";
