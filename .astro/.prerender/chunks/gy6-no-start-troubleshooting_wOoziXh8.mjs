...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.p, {
      ...
      children: ["Replace the spark plug if in doubt — they cost very little and eliminate the plug as a variable. Standard NGK plug for all GY6 50cc–150cc (139QMB, 152QMI, 157QMJ): ", createVNode(_components.strong, {
        children: createVNode(_components.code, {
          children: "CR7HSA"
        })
      }), " (resistor type, recommended for EFI and CDI scooters). Non-resistor equivalent: ", createVNode(_components.code, {
        children: "C7HSA"
      }), ". Iridium upgrade: ", createVNode(_components.code, {
        children: "CR7HIX"
      }), ". Thread: 10 mm, reach: 12.7 mm, gap: 0.6–0.7 mm. The older Chinese-market codes ", createVNode(_components.code, {
        children: "A7TC"
      }), " / ", createVNode(_components.code, {
        children: "A7RTC"
      }), " cross-reference to ", createVNode(_components.code, {
        children: "C7HSA"
      }), " / ", createVNode(_components.code, {
        children: "CR7HSA"
      }), " respectively — use the NGK part number when sourcing."]
    }), "\n", createVNode(_components.h3, {
...
const file = "/sessions/friendly-eager-maxwell/mnt/interactive scooter repair manuals - ISRM/src/content/diagnostics/gy6-no-start-troubleshooting.mdx";
...
Content.moduleId = "/sessions/friendly-eager-maxwell/mnt/interactive scooter repair manuals - ISRM/src/content/diagnostics/gy6-no-start-troubleshooting.mdx";
