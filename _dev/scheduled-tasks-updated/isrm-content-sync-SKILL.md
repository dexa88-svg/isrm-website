...
description: Check scooter repair sources for new content and generate pages for the ISRM website
---

## ISRM Content Sync — Daily Run

You are maintaining the **Interactive Scooter Repair Manuals (ISRM)** website. The project covers **benzine (petrol) scooters** only — specifically:
...
<body>
  <nav><a href="../index.html">🔧 ISRM Home</a> › <a href="index.html">[Category Name]</a></nav>
  <h1>[Page Title]</h1>
  <div class="meta">
  ...
  <footer>
    Page auto-generated by ISRM Content Sync on [date]. Content summarised from external sources for educational purposes. Always verify with the original source before performing repairs.
  </footer>
</body>
</html>
```
